...
namespace Neu.SmartContract
{
    public class StateReader : InteropService
    {
        ...
        public StateReader()
        {
            Register("Neu.Runtime.GetTrigger", Runtime_GetTrigger);
            Register("Neu.Runtime.CheckWitness", Runtime_CheckWitness);
            Register("Neu.Runtime.Notify", Runtime_Notify);
            Register("Neu.Runtime.Log", Runtime_Log);
            Register("Neu.Blockchain.GetHeight", Blockchain_GetHeight);
            Register("Neu.Blockchain.GetHeader", Blockchain_GetHeader);
            Register("Neu.Blockchain.GetBlock", Blockchain_GetBlock);
            Register("Neu.Blockchain.GetTransaction", Blockchain_GetTransaction);
            Register("Neu.Blockchain.GetAccount", Blockchain_GetAccount);
            Register("Neu.Blockchain.GetValidators", Blockchain_GetValidators);
            Register("Neu.Blockchain.GetAsset", Blockchain_GetAsset);
            Register("Neu.Blockchain.GetContract", Blockchain_GetContract);
            Register("Neu.Header.GetHash", Header_GetHash);
            Register("Neu.Header.GetVersion", Header_GetVersion);
            Register("Neu.Header.GetPrevHash", Header_GetPrevHash);
            Register("Neu.Header.GetMerkleRoot", Header_GetMerkleRoot);
            Register("Neu.Header.GetTimestamp", Header_GetTimestamp);
            Register("Neu.Header.GetConsensusData", Header_GetConsensusData);
            Register("Neu.Header.GetNextConsensus", Header_GetNextConsensus);
            Register("Neu.Block.GetTransactionCount", Block_GetTransactionCount);
            Register("Neu.Block.GetTransactions", Block_GetTransactions);
            Register("Neu.Block.GetTransaction", Block_GetTransaction);
            Register("Neu.Transaction.GetHash", Transaction_GetHash);
            Register("Neu.Transaction.GetType", Transaction_GetType);
            Register("Neu.Transaction.GetAttributes", Transaction_GetAttributes);
            Register("Neu.Transaction.GetInputs", Transaction_GetInputs);
            Register("Neu.Transaction.GetOutputs", Transaction_GetOutputs);
            Register("Neu.Transaction.GetReferences", Transaction_GetReferences);
            Register("Neu.Attribute.GetUsage", Attribute_GetUsage);
            Register("Neu.Attribute.GetData", Attribute_GetData);
            Register("Neu.Input.GetHash", Input_GetHash);
            Register("Neu.Input.GetIndex", Input_GetIndex);
            Register("Neu.Output.GetAssetId", Output_GetAssetId);
            Register("Neu.Output.GetValue", Output_GetValue);
            Register("Neu.Output.GetScriptHash", Output_GetScriptHash);
            Register("Neu.Account.GetScriptHash", Account_GetScriptHash);
            Register("Neu.Account.GetVotes", Account_GetVotes);
            Register("Neu.Account.GetBalance", Account_GetBalance);
            Register("Neu.Asset.GetAssetId", Asset_GetAssetId);
            Register("Neu.Asset.GetAssetType", Asset_GetAssetType);
            Register("Neu.Asset.GetAmount", Asset_GetAmount);
            Register("Neu.Asset.GetAvailable", Asset_GetAvailable);
            Register("Neu.Asset.GetPrecision", Asset_GetPrecision);
            Register("Neu.Asset.GetOwner", Asset_GetOwner);
            Register("Neu.Asset.GetAdmin", Asset_GetAdmin);
            Register("Neu.Asset.GetIssuer", Asset_GetIssuer);
            Register("Neu.Contract.GetScript", Contract_GetScript);
            Register("Neu.Storage.GetContext", Storage_GetContext);
            Register("Neu.Storage.Get", Storage_Get);
