...
namespace Neu.SmartContract
{
    public class StateMachine : StateReader
    {
        ...
        public StateMachine(DataCache<UInt160, AccountState> accounts, DataCache<ECPoint, ValidatorState> validators, DataCache<UInt256, AssetState> assets, DataCache<UInt160, ContractState> contracts, DataCache<StorageKey, StorageItem> storages)
        {
            ...
            Register("Neu.Account.SetVotes", Account_SetVotes);
            Register("Neu.Validator.Register", Validator_Register);
            Register("Neu.Asset.Create", Asset_Create);
            Register("Neu.Asset.Renew", Asset_Renew);
            Register("Neu.Contract.Create", Contract_Create);
            Register("Neu.Contract.Migrate", Contract_Migrate);
            Register("Neu.Contract.GetStorageContext", Contract_GetStorageContext);
            Register("Neu.Contract.Destroy", Contract_Destroy);
            Register("Neu.Storage.Put", Storage_Put);
            Register("Neu.Storage.Delete", Storage_Delete);
